...
export async function handleTelegramUpdate(botToken, offset) {
  // Richiedi solo i nuovi messaggi usando l'offset
  let getUpdatesUrl = `https://api.telegram.org/bot${botToken}/getUpdates`;
